...
Route::put('/games/{games}/update',[GameController::class, 'update'])->name('games.update');
Route::delete('/games/{games}/delete',[GameController::class, 'delete'])->name('games.delete');